...
class StyleGuide extends Component {
  render() {
    ...
    <section className='container'>
      ...
      <p>This page is a basic style guide for your React based app. <strong>By default most styles are turned off.</strong> Styles can be turned on in the "src/assets/scss/style.scss" file by uncommenting the sections you would like to add to your app. Only use the ones that you need to keep your files as small as possible.</p>
        <p>All CSS assumes a mobile-first approach. Media queries are handeled as mixins. See "src/assets/assets/scss/_base.scss" for example on how to use them.</p>
        </div>
      </div>
